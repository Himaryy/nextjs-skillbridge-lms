...
export default async function CoursePageDetails({
  params,
}: {
  params: Params;
}) {
    ...
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 mt-5">
      <div className="order-1 lg:col-span-2">
        <div className="relative aspect-video w-full overflow-hidden rounded-xl shadow-lg">
          <Image
            // i just copy the link from useConstruct because it can use on async fuinction
            src={`https://${env.NEXT_PUBLIC_S3_BUCKET_NAMES_IMAGES}.t3.storage.dev/${course.fileKey}`}
            alt=""
            fill // use fill because i have parent div but u can still w/h
            className="object-cover"
            priority // use this for fetch image 1st then other code , cause this is a hero image
          />
        ...
        <div className="mt-12 space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div>
              ...
              {/* Get Each lesson in chapter and calculate */}
          ...
          <div className="space-y-4">
            {course.chapter.map((chapter, index) => (
              <Collapsible key={chapter.id} defaultOpen={index === 0}>
                <Card className="p-0 overflow-hidden border-2 transition-all duration-200 gap-0 hover:shadow-md">
                  <CollapsibleTrigger>
                    <div>
